report <- function (reportDir, reportFile, sends, receives, threadFiles, gcFiles, fullGcFiles, startTimeEpochMillis, xMin = -.Machine$integer.max, xMax = .Machine$integer.max) {
  ...
  endTimeNanos = max(sendDataSubset$PubTime, sendDataSubset$PubRecReceiveTime, sendDataSubset$PubRelSendTime, sendDataSubset$PubCompReceiveTime, receiveDataSubset$PubTime, receiveDataSubset$PubRecReceiveTime, receiveDataSubset$PubRelSendTime, receiveDataSubset$PubCompReceiveTime, connectionData$conn_init*10^6, connectionData$conn_comp*10^6, connectionData$sub_comp*10^6)
